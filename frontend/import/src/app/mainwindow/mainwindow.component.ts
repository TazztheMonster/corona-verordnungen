...
export class MainwindowComponent implements OnInit {
  ...
  provinces: Province[] = [
    ...
    {province: 'RHEINLAND_PALATINATE', personsIndoor: 12, personsOutdoor:50, householdsIndoor: 5, householdsOutdoor: 10, maskMandatory: true, buildingTypesClosed:[{buildingType : 'Schulen'}], personsPsmIndoor: 4, personsPsmOutdoor: 6, other:''},
